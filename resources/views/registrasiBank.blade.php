			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="" data-toggle="collapse"><i class="lnr lnr-chart-bars"></i> 
					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
						                ...
						                <div style="padding: 150px;">
						                    <img src="bri.gif" height= "160px" width="220" style="padding-left: 60px; padding-right: 30px; padding-top: 30px;"/>
						                    <img src="bca.png" height= "160px" width="220" style="padding: 30px;"/>
						                    <img src="BTN.jpg" height= "160px" width="220" style="padding: 30px;"/>
						            	</div>
						</div>
					</div>
				</div>
