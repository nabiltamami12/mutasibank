...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('/Login_v3/images/bg-01.jpg');">
			...
			<form class="login100-form validate-form" action="/bri/scrap" method="POST">
					@csrf
					<span class="login100-form-logo">
				<img src="{{asset('/Login_v3/images/bri.png')}}" style="width: 150px; height: auto; padding-top: 10px">
					</span>
