	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('/Login_v3/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" autocomplete="off" action="{{url('/bca/scrap')}}" method="POST">
					@csrf
					<span class="login100-form-logo" style="">
					
    
				<img src="/Login_v3/images/bca.png" style="width: 150px; height: auto; padding-top: 10px;">
					</span>
